...
$cari = $_POST['keyword'];
$sql = "SELECT * FROM dapen WHERE nama LIKE '%$cari%'
        OR nik LIKE '%$cari%' ";
            ...
            ?>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?= $row['alamat']; ?></td>
                        <td>
                            <a href="dapen/detail.php?id=<?= $row['id']; ?>"><button class="btn btn-primary m-auto"><i class=" far fa-eye"></i> Lihat</button></a>
                            <a href="dapen/edit.php?id=<?= $row['id']; ?>"><button class="btn btn-success m-auto"><i class="fas fa-user-edit"></i> Ubah</button></a>
                            <a href="dapen/hapus.php?id=<?= $row['id']; ?>" onclick="return confirm ('yakin mau dihapus?')"><button class="btn btn-danger m-auto"><i class="fas fa-trash-alt"></i> Hapus</button></a>
                        </td>
                    </tr>
